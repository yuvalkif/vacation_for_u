...
public class View implements IView {
    ...
    public void handleVacationButton(){
        FXMLLoader loader = new FXMLLoader();
        try{
            loader.load(getClass().getClassLoader().getResource("VacationForm.fxml").openStream());
            Stage stage = initializeNewStage("VacationForm.fxml","Forms.css","Vacation",false,650,500);
